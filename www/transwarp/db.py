...
class Dict(dict):
    ...
    '3'
    >>>d2['empty']
    Traceback (most recent cakk last):
        ...
    KeyError:'empty'
    >>>d2.empty
    Traceback (most recent cakk last):
...
class _ConnectionCtx(object):
    '''
    _ConnectionCtx object that can open and close connection contex.
    _Connection object can be nested and only the most outer connection has effect.
